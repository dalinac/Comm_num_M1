...
% 
% Output:
% x - m-by-n matrix with violet noise samples 
%     with mu = 0 and sigma = 1 (columnwise)
%
% The function generates a matrix of violet noise samples.
% In terms of power at a constant frequency bandwidth, the violet 
% noise increases in by 6 dB/oct i.e., 20 dB/dec.
