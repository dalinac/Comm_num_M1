...
% 
% Output:
% x - m-by-n matrix with blue noise samples 
%     with mu = 0 and sigma = 1 (columnwise)
%
% The function generates a matrix vector of blue noise samples.
% In terms of power at a constant frequency bandwidth, the blue 
% noise increases in by 3 dB/oct i.e., 10 dB/dec.
