...
% ------------------------------------------------------------------------------------------------------------------------------
            case 10                                                                                           % (FIG 0/10) Date and Time
                ...
                if FIGDataLength == 5                                                                         % Short Form
                    ...
                    disp(sprintf('FrameNr: %2d FIB: %2d Type: %2d Extension: %2d C/N: %1d OE: %1d P/D: %1d Date: %04d/%02d/%02d Time: %02d:%02d:%02d:%02d UTC'...
            ...
            case 17                                                                                           % (FIG 0/17) Programm Type
                ...
                while pos<length(Data)
                    ...
                    if LFlag == 1                                                           % Tabelle von TS 101 765 [16] implementiert
                        disp(BintoDez(Data(pos+24:pos+31),8));
