...
import OFDM_wav_TS_step_04_epy_block_demod as epy_block_demod  # embedded python block
import OFDM_wav_TS_step_04_epy_block_mod as epy_block_mod  # embedded python block
import OFDM_wav_TS_step_04_epy_block_pack as epy_block_pack  # embedded python block
import OFDM_wav_TS_step_04_epy_block_unpack as epy_block_unpack  # embedded python block
import math
import sip



class OFDM_wav_TS_step_04(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OFDM_wav_TS_step_04", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OFDM_wav_TS_step_04")
        ...
        self.settings = Qt.QSettings("GNU Radio", "OFDM_wav_TS_step_04")
        ...
        labels = ['pi/4-DQPSK', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.epy_block_unpack = epy_block_unpack.blk()
        self.epy_block_pack = epy_block_pack.blk()
        self.epy_block_mod = epy_block_mod.blk()
        self.epy_block_demod = epy_block_demod.blk()
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_short*1, (audio_Fs * 2), True, 0 if "auto" == "auto" else max( int(float(0.1) * (audio_Fs * 2)) if "auto" == "time" else int(0.1), 1) )
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_char*1, 2)
        self.blocks_short_to_float_1 = blocks.short_to_float(1, 32768)
        ...
        self.connect((self.blocks_repack_bits_bb_1, 0), (self.blocks_stream_to_vector_0, 0))
        ...
        self.connect((self.blocks_stream_to_vector_0, 0), (self.epy_block_pack, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.epy_block_unpack, 0))
        ...
        self.connect((self.digital_constellation_encoder_bc_0, 0), (self.epy_block_mod, 0))
        self.connect((self.epy_block_demod, 0), (self.blocks_repack_bits_bb_1, 0))
        self.connect((self.epy_block_mod, 0), (self.epy_block_demod, 0))
        self.connect((self.epy_block_mod, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.epy_block_pack, 0), (self.blocks_deinterleave_0, 0))
        self.connect((self.epy_block_unpack, 0), (self.blocks_vector_to_stream_0, 0))
    ...
    def set_audio_Fs(self, audio_Fs):
        ...
        self.blocks_throttle2_0.set_sample_rate((self.audio_Fs * 2))




def main(top_block_cls=OFDM_wav_TS_step_04, options=None):
