...
# Title: OFDM_wav_TS_step_03_04_C
...
class OFDM_wav_TS_step_03_04_C(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OFDM_wav_TS_step_03_04_C", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OFDM_wav_TS_step_03_04_C")
        ...
        self.settings = Qt.QSettings("GNU Radio", "OFDM_wav_TS_step_03_04_C")
...
def main(top_block_cls=OFDM_wav_TS_step_03_04_C, options=None):
