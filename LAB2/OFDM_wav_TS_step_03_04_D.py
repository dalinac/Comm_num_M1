...
# Title: OFDM_wav_TS_step_03_04_D
...
class OFDM_wav_TS_step_03_04_D(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OFDM_wav_TS_step_03_04_D", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OFDM_wav_TS_step_03_04_D")
        ...
        self.settings = Qt.QSettings("GNU Radio", "OFDM_wav_TS_step_03_04_D")
        ...
        self.digital_constellation_encoder_bc_0_0 = digital.constellation_encoder_bc(my_const_2)
        ...
        self.connect((self.blocks_complex_to_arg_0_0, 0), (self.blocks_multiply_const_vxx_2, 0))
        ...
        self.connect((self.channels_channel_model_0, 0), (self.blocks_stream_demux_0, 0))
        ...
        self.connect((self.digital_constellation_encoder_bc_0_0, 0), (self.blocks_complex_to_arg_0_0, 0))
    ...
    def set_my_const_2(self, my_const_2):
        ...
        self.digital_constellation_encoder_bc_0_0.set_constellation(self.my_const_2)
...
def main(top_block_cls=OFDM_wav_TS_step_03_04_D, options=None):
