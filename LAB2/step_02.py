...
import sip
import step_02_epy_block_0 as epy_block_0  # embedded python block
import step_02_epy_block_1 as epy_block_1  # embedded python block



class step_02(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "step_02")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/bida/Downloads/LAB2-20260323/sine_16.wav', True)
        ...
        self.connect((self.blocks_short_to_float_0_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_stream_to_vector_0, 0), (self.epy_block_0, 0))
        self.connect((self.blocks_throttle2_1, 0), (self.blocks_short_to_float_0, 0))
        ...
        self.connect((self.epy_block_0, 0), (self.blocks_short_to_float_0_0, 0))
...
def main(top_block_cls=step_02, options=None):
