...
class step_03_04_B(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Step 03 04 B", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Step 03 04 B")
        ...
        self.settings = Qt.QSettings("GNU Radio", "step_03_04_B")
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 4, 1024))), True)
        ...
        self.connect((self.blocks_stream_demux_0, 1), (self.qtgui_const_sink_x_0, 2))
...
def main(top_block_cls=step_03_04_B, options=None):
